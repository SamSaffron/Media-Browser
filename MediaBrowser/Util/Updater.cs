...
namespace MediaBrowser.Util
{
    ...
    public class Updater
    {
        ...
        private const string infoURL = "http://videobrowser.ch/mbinfo.xml";
               ...
               // appRef.displayDialog("Test", "Test", (DialogButtons)12, 10000);
                ...
                if (CurrentVersion < newVersion)
                {
                    if (Application.MediaCenterEnvironment.Capabilities.ContainsKey("Console"))
                    {
                        ...
                        DialogResult reply = appRef.displayDialog("Do you wish to update Media Browser now?  (Requires you to grant permissions and a restart of Media Browser)", "Update Available", (DialogButtons)12 /* Yes, No */, 10);
                    ...
                    else
                    {
                        ...
                        // an extender.
                        DialogResult reply = appRef.displayDialog("There is an update available for Media Browser.  Please update Media Browser next time you are at your MediaCenter PC.", "Update Available", (DialogButtons)1 /* OK */, 10);
                    }
                }
            }
            catch (Exception)
        ...
        private void DownloadUpdate()
        {
            ...
            else
            {
                ...
                DialogResult reply = appRef.displayDialog("Media Browser will operate normally and prompt you again the next time you load it.", 
        ...
        public void DownloadComplete()
        {
            ...
            DialogResult reply = appRef.displayDialog("Media Browser must now exit to apply the update.  It will restart automatically when it is done", 
