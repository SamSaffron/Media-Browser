    ...
    public class Updater
    {
        ...
        private void DownloadUpdate()
        {
            ...
            else
            {
                ...
                DialogResult reply = appRef.displayDialog("VideoBrowser will operate normally and prompt you again the next time you load it.", 
        ...
        public void DownloadComplete()
        {
            ...
            DialogResult reply = appRef.displayDialog("VideoBrowser must now exit to apply the update.  It will restart automatically when it is done", 
            ...
            updateBat += "C:\\windows\\ehome\\ehshell /entrypoint:{97a99e2f-2c25-427d-ad18-0262045a7377}\\{547c16aa-6ec4-41a3-953e-242333b60df0}";
